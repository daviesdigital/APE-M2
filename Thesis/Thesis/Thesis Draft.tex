...
\begin{center}
	\begin{minipage}{0.90\linewidth}
		...
		\bb
		Je voudrais également remercier Daniel, Habib, et Claire, qui m'ont permis de me sentir chez moi à Paris tout au long de mon séjour et qui m'ont offert une famille lorsque la mienne n'était pas proche
		\bb
...
A vast portion of policy analysis is still based on rational expectations models, often with a perfectly rational representative agent \cite{hommes2021behavioral}. Recent financial-economic crises, have shown however, that alternative approaches are needed in order to more appropriately model, understand, and manage crises. In recent years we have seen the emergence of behavioural macroeconomic models which challenge these traditional assumptions, claiming to better capture more nuanced, real-world economic behaviour, particularly during times of turmoil.
\bb
The integration of behavioural economics into macroeconomic theory has opened new avenues for understanding how policy decisions influence economic outcomes. One recent impactful advancemnet in the field is the work done by Xavier Gabaix. His work on Sparse maximisation 



Talk about how, while his paper broke much needed ground, fiscal policy in the model is limited to lump-sum transfers/taxes.

If the aim of behavioural macroeconomics is to better model everyday economic behaviour we must analyse how cognitive biases interact with distortionary taxes 

While previous work done on distortionary taxes has born fruitful conclusions, there has yet to be an integration of these distortionary taxes within a behavioural new keynesian framework
...
In a standard New Keynesian model, the Phillips Curve is derived based on the concept of price stickiness, where firms do not adjust prices instantly in response to economic changes. When cognitive discounting is introduced, the Behavioral Phillips Curve emerges, accounting for firms' limited attention or imperfect cognition. This means that decision-makers at firms do not fully consider the future state of the economy when setting prices.
\bb
...
\bb
Post-shock, the model would prescribe an increase in consumption taxes to stabilize prices and restore the natural rate of interest to positive levels. However, the persistence of cognitive discounting means that agents under-react to this increase, leading to prolonged periods of low consumption and delayed economic recovery. Similarly, reducing labour taxes would be necessary to encourage labor supply and increase output. But again, cognitive discounting cause agents to undervalue the future benefits of lower taxes, resulting in a slower than expected response in labour market recovery.
\bb
...
\subsection{The effect of sales tax alone}

\subsection{The effect of labour tax alone}

\subsection{The effect of the combination}
...
\bb
\textbf{Unlike traditional New Keynesian models with perfectly rational agents, debt dynamics in our behavioural model will therefore have }
...
Finally, let us consider what happens when the government purchases an amount $G_t$ of the aggregate good, and consumes it. Similarly to \cite{gabaix2020behavioural} and \cite{eggertsson2011fiscal}, we assume that this enters additively in the utility function so that this does not distort the agent?s decision. This results in a utility function which takes the form:
...
\end{align*}
The fiscal multiplier derived here is closely aligned with the findings of \cite{gabaix2020behavioural}, though with a key distinction. Our result captures both the direct impact of government spending on GDP but also the additional indirect effect. This indirect effect occurs are as individuals feel wealthier as their income increases by $G_0$ but do not fully internalise the future associated tax burden due to cognitive discounting. Once again the extent of their cognitive discounting is capture by the value of $\bar{m}$. In the rational case, where $\bar{m} = 1$ we see that this indirect channel disappears, $b_d = 0$ as agents fully perceive future taxes. However in the case of behavioural agents, where $0 \leq \bar{m} < 1$, this indirect effect plays a crucial role.
\bb 
