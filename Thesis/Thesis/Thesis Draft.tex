...
\subsection{Outline}
This paper begins by introducing traditional New Keynesian model with distortionary taxes as developed in papers by \cite{correia2013unconventional} and \cite{correia2013unconventional}. This will serve as a foundation on which we can build and provides a basis for understanding how distortionary taxes, such as those on labor and consumption, influence economic behavior under standard assumptions.
\bb
...
\end{align}
where $M$, $\kappa$, and $\psi$ capture the effects of cognitive discounting and tax distortions.
